 ...
 * @flags:  Calculates curren active flags.
 * @width: get width.
 * @precision: Specifier
 * @size: Specifier
 *
 ...
 * @ind: Index at which the num will starts on the buffer
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
 * @prec: Specifier
 ...
 * @ind: Index at which the number will starts in the buffer
 ...
 * @padd_start: Index start padding 
 *
 * Return: Number of characterss written.
 */
